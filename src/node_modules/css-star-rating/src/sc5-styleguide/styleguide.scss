...
(in this html is additional angular markup to make the showcase interactive)
   ...
   markup:
   <div ng-init="data.rating = 0" class="rating padding value-{{data.rating}}">
    <div class="star-container">
        <div class="star" ng-repeat="i in [1,2,3,4,5] track by $index" ng-click="data.rating = $index+1">
