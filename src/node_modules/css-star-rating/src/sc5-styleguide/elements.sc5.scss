...
<b>Label:</b>
<div class="label-value {$modifiers}">good</div>
...
markup:
<div class="star filled svg {$modifiers}">
  <svg class="star-empty">
      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/star-rating.icons.svg#star-empty"></use>
  </svg>
  <svg class="star-half">
...
<div class="star filled icon {$modifiers}">
  <svg class="star-empty">
      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/star-rating.icons.svg#star-empty"></use>
  </svg>
  <svg class="star-half">
...
markup:
<div class="star empty {$modifiers}">
  <svg class="star-empty">
      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/star-rating.icons.svg#star-empty"></use>
  </svg>
  <svg class="star-half">
...
none                    - displays star in default size (medium)
...
none                    - displays star in normal (medium)
.disabled               - displays star in disabled state

markup:
<div class="star half positive {$modifiers}">
  <svg class="star-empty">
      <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/star-rating.icons.svg#star-empty"></use>
  </svg>
  <svg class="star-half">
...
none                    - displays star icon in left to right direction. (direction-ltr)
...
none                    - displays star in left to right direction. (direction-ltr)
...
markup:
<div class="label-value {$modifiers}">3.5</div>
...
none                    - displays label in normal (medium)
